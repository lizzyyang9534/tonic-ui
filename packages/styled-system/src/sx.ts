...
const createPseudoResolver = (theme: any) => (styleProps: any): Record<string, any> => {
...
const createResponsiveResolver = (theme: any) => (styleProps: any): Record<string, any> => {
  const next = {};
...
const sx = (valueOrFn: any) => (props: any = {}): Record<string, any> => {
